...
public class MeetResponse extends SessionResponse implements KvmSerializable
{
    ...
    public MeetResponse (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("meet"))
                {
                    if(obj!=null)
                    {
                        java.lang.Object j = obj;
                        this.meet = (MeetData)__envelope.get(j,MeetData.class);
                    }
                    continue;
                }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        {
            return this.meet!=null?this.meet:SoapPrimitive.NullSkip;
        }
