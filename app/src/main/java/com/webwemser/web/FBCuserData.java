...
public class FBCuserData extends FBCdataTransferObject implements KvmSerializable
{
    ...
    public FBCuserData (Object paramObj,FBCExtendedSoapSerializationEnvelope __envelope)
    {
