...
// Version: 4.5.6.0
//
// Created by Quasar Development at 17/06/2016
//
//---------------------------------------------------
...
/**
 * MeetPreviewData from server
 * generated using easywsdl.com
 * @author Christian
 */
public class MeetPreviewData extends DataTransferObject implements KvmSerializable
{
    ...
    public Integer currentGuests=0;
    ...
    public MeetPreviewData(Object paramObj, ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("admin"))
                {
                    if(obj!=null)
                    {
                        ...
                        if (obj.getClass().equals(SoapPrimitive.class))
                        {
                            ...
                            if(j.toString()!=null)
                            {
                                this.admin = j.toString();
                            }
                        }
                        else if (obj instanceof String){
                            this.admin = (String)obj;
                        }
                    }
                    continue;
                }
                ...
                if (info.name.equals("currentGuests"))
                {
                    if(obj!=null)
                    {
                        ...
                        if (obj.getClass().equals(SoapPrimitive.class))
                        {
                            ...
                            if(j.toString()!=null)
                            {
                                this.currentGuests = Integer.parseInt(j.toString());
                            }
                        }
                        else if (obj instanceof Integer){
                            this.currentGuests = (Integer)obj;
                        }
                    }
                    continue;
                }
