...
public class KILExtendedSoapSerializationEnvelope extends SoapSerializationEnvelope {
    static HashMap< java.lang.String,java.lang.Class> classNames = new HashMap< java.lang.String, java.lang.Class>();
    static {
        classNames.put("http://web/^^sessionResponse",KILsessionResponse.class);
        classNames.put("http://web/^^returnCodeResponse",KILreturnCodeResponse.class);
        classNames.put("http://web/^^dataTransferObject",KILdataTransferObject.class);
      ...
      /*  classNames.put("http://web/^^user",KILuser.class);
        ...
        classNames.put("http://web/^^conversationData",KILconversationData.class);
        classNames.put("http://web/^^userContentData",KILuserContentData.class);
        classNames.put("http://web/^^replyData",KILreplyData.class);
        classNames.put("http://web/^^userPersistenceData",KILuserPersistenceData.class);
    ...
    public KILExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public KILExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new KILMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            ...
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=KILHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    public java.lang.Object get(java.lang.Object soap,java.lang.Class cl)
    {
        ...
        try
        {
            ...
            {
                Constructor ctor = cl.getConstructor(java.lang.Object.class,KILExtendedSoapSerializationEnvelope.class);
