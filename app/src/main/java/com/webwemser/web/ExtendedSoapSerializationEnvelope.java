...
public class ExtendedSoapSerializationEnvelope extends SoapSerializationEnvelope {
    ...
    static {
        classNames.put("http://web.letsmeet/^^sessionResponse",SessionResponse.class);
        classNames.put("http://web.letsmeet/^^returnCodeResponse",ReturnCodeResponse.class);
        classNames.put("http://web.letsmeet/^^dataTransferObject",DataTransferObject.class);
        classNames.put("http://web.letsmeet/^^sessionData",SessionData.class);
        classNames.put("http://web.letsmeet/^^userData",UserData.class);
        classNames.put("http://web.letsmeet/^^meetsResponse",MeetsResponse.class);
        classNames.put("http://web.letsmeet/^^meetData",MeetData.class);
        classNames.put("http://web.letsmeet/^^conversationData",ConversationData.class);
        classNames.put("http://web.letsmeet/^^userContentData",UserContentData.class);
        classNames.put("http://web.letsmeet/^^userPersistenceData",UserPersistenceData.class);
        classNames.put("http://web.letsmeet/^^meetResponse",MeetResponse.class);
        classNames.put("http://web.letsmeet/^^categoriesResponse",CategoriesResponse.class);
    }   
